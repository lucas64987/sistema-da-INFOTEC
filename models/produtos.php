...
class produto
{
    ...
    {
        try {
            $query = "INSERT INTO {$this->table} (nome, descricao , quantidade, preco, preco_venda, categoria, cod_produto') VALUES (:nome, :descricao, :quantidade, :preco, :preco_venda, :categoria, :cod_produto)";
    ...
    {
        try {
            $sql = "UPDATE {$this->table} SET nome = :nome, descricao = :descriacao,
